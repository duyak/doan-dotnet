    ...
    public class MyUserController : Controller
    {
        ...
        public ActionResult Login(UserLogin userLogin, string ReturnUrl="")
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                dotnetstorephoneEntities p = new dotnetstorephoneEntities();
        ...
        public ActionResult ForgotPassWord(string email)
        {
            string message = "";
            bool status = false;
            using(dotnetstorephoneEntities p = new dotnetstorephoneEntities())
            {
        ...
        {
            dotnetstorephoneEntities phone_Store = new dotnetstorephoneEntities();
        ...
        public void SendVerificationSendLinkEmail(string email, int id)
        {
            ...
            var fromemail = new MailAddress("nguyendangduyak1998@gmail.com", "Shop");//từ email này
            var toEmail = new MailAddress(email);//gửi nội dung đến email này
            var fromEmailPass = "nmxkuxuzbccypome";
